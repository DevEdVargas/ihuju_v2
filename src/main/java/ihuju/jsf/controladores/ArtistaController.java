...
import ihuju.ejb.fachadas.ArtistaFacade;
import java.io.File;
...
public class ArtistaController implements Serializable {
    ...
    @EJB
    private ihuju.ejb.fachadas.ArtistaFacade ejbFacade;
    ...
    public void preProcessPDF(Object document) throws IOException, BadElementException, DocumentException {
        ...
        Paragraph subtitulo = new Paragraph("artista", new Font(Font.HELVETICA, 15));
        titulo.setAlignment("center");
        titulo.setSpacingAfter(10);
        pdf.add(subtitulo);
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ArtistaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ArtistaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("ArtistaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Artista getArtista(java.math.BigDecimal id) {
    ...
    public static class ArtistaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Artista) {
                ...
                return getStringKey(o.getPkArtista());
            } else {
