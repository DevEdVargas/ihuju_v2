...
public class EventoController implements Serializable {
    ...
    @EJB
    private ihuju.ejb.fachadas.EventoFacade ejbFacade;
    ...
    public void preProcessPDF(Object document) throws IOException, BadElementException, DocumentException {
        ...
        Paragraph subtitulo = new Paragraph("evento", new Font(Font.HELVETICA, 15));
        titulo.setAlignment("center");
        titulo.setSpacingAfter(10);
        pdf.add(subtitulo);
    ...
    public Evento getEvento(java.math.BigDecimal id) {
    ...
    public static class EventoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Evento) {
                ...
                return getStringKey(o.getPkEvento());
            } else {
