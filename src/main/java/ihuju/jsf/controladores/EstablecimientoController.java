...
import ihuju.ejb.fachadas.EstablecimientoFacade;
import java.io.File;
...
public class EstablecimientoController implements Serializable {
    ...
    @EJB
    private ihuju.ejb.fachadas.EstablecimientoFacade ejbFacade;
    ...
    public void preProcessPDF(Object document) throws IOException, BadElementException, DocumentException {
        ...
        Paragraph subtitulo = new Paragraph("establecimiento", new Font(Font.HELVETICA, 15));
        titulo.setAlignment("center");
        titulo.setSpacingAfter(10);
        pdf.add(subtitulo);
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("EstablecimientoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("EstablecimientoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("resources/Bundle").getString("EstablecimientoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Establecimiento getEstablecimiento(java.math.BigDecimal id) {
    ...
    public static class EstablecimientoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Establecimiento) {
                ...
                return getStringKey(o.getPkEstablec());
            } else {
