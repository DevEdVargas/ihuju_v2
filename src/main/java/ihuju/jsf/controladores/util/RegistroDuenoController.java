...
@Named("registroDuenoController")
@SessionScoped
public class RegistroDuenoController implements Serializable {

    private Usuario currentUsuario;
    private Duenio currentDuenio;
    private Establecimiento currentEstablecimiento;
    private Generomusica currentGeneromusica;
    private Estatipgen currentEstatipgen;
    private Estagenmusi currentEstagenmusi;
    private Tipogenero currentTipogenero;
    private Estadispo currentEstadispo;
    private Disponibilidad currentDisponibilidad;
    ...
    public RegistroDuenoController() {
