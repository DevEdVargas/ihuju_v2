 ...
 */
@Entity
@Table(name = "ESTADOUSUARIO", catalog = "", schema = "IHUJU")
@XmlRootElement
@NamedQueries({
...
public class Estadousuario implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "SQ_ESTADOUSUARIO", sequenceName = "SQ_ESTADOUSUARIO", initialValue = 1, allocationSize = 1) 
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_ESTADOUSUARIO")
