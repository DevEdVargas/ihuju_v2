 ...
 */
@Stateless
@Path("ihuju.jpa.entidades.establecimiento")
public class EstablecimientoFacadeREST extends AbstractFacade<Establecimiento> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Establecimiento entity) {
        super.edit(entity);
    }
    ...
    public Establecimiento find(@PathParam("id") BigDecimal id) {
